...
class ProductRepository:
    ...
    def get_product_stock_range(self, min_stock, max_stock):
        return Product.objects.filter(stock__gte=min_stock, stock__lte=max_stock)
    
    def get_product_lte_stock(self, stock_threshold):
